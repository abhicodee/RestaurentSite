...
const Product = () => {
  ...
  const Menudata = [
    ...
    },
    {
      id: 40,
      image:
        "https://images.unsplash.com/photo-1585665187093-a3511c2fe57a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8ZGVzc2VydCUyMHBsYXRlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=600&q=60",
      name: "cup cake",
      categoary: "dessert",
      rating: 4.5,
      orders: 20,
    ...
    },
    {
      id: 41,
      image:
        "https://images.unsplash.com/photo-1497681204192-eb12c0702305?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8ZGVzc2VydCUyMHBsYXRlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=600&q=60",
      name: "cream cake",
      categoary: "dessert",
      rating: 4.1,
      orders: 20,
    ...
    },
    {
      id: 42,
      image:
        "https://images.unsplash.com/photo-1613914428655-c4940a87b6ca?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTF8fGRlc3NlcnQlMjBwbGF0ZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=600&q=60",
      name: "mix fruit cake",
      categoary: "dessert",
      rating: 4.7,
      orders: 26,
    ...
    },
    {
      id: 43,
      image:
        "https://images.unsplash.com/photo-1615460739599-b217b00373b0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTN8fGRlc3NlcnQlMjBwbGF0ZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=600&q=60",
      name: "cup cake",
      categoary: "dessert",
      rating: 4.5,
      orders: 20,
    ...
    <>
      ...
      <div className="cart-container">
        {Menudata.map((currEle) => {
          return (
            <>
              {currEle.id > start && currEle.id < end && (
                <div className="cart">
                  < div className="containerrr"> 
           <img className="imgep" src={currEle.image}></img>
                </div>
